...
namespace SchoolApp.ID.Server.Controllers
{
    [SecurityHeaders]
    [AllowAnonymous]
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (button != "login")
            {
                ...
                else
                {
                    ...
                    return Redirect($"https://localhost:44301/account/login?returnTo=index");
                }
            }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            ...
            var claimer = new AppClaimsPrincipalFactory(_userManager, _roleManager, _identityOptions);

            await claimer.CreateAsync(user);
